...
#define MAX_ERROR_ANGLE 18.0  //最大倾斜角度，超过就停止
#define X_BALANCE_ANGLE 1.16 //平衡时俯仰角的倾角
#define Y_BALANCE_ANGLE -0.05 //平衡时翻滚角的倾角

#define BALANCE_KP 10//平衡环pid
#define BALANCE_KI 0.6
#define BALANCE_KD 0.8
#define BALANCE_IMAX 30
#define BALANCE_OUTMAX 5000
#define SPEED_KP 0.1    //速度环PID
#define SPEED_KI 0
#define SPEED_KD 0
...
{
public:
    static double motor_speed[3];     //储存三个轮子的旋转速度
...
private:
    ...
    float real_motor_speed[3];    //储存三个电机的实际转速
...
public:
  ...
  void move_solution(float x_speed, float y_speed, float angular_velocity);
  //读取JY901数据
  void serialEvent();
  //机器人初始化
  void BQ8Init();
